###############################################################################################################################################################################
## BE ADVISED, AT THE PRESENT MOMENT, I USE A ZSH PLUGIN, SO THIS ZSHRC FILE IS NO LONGER USED BY ME DUE TO ISSUES PERTAINING TO LOAD TIMES WHEN CHANGING DIRECTORIES
###############################################################################################################################################################################
